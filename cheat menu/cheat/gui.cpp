...
void gui::Render() noexcept
{
	...
	if (ImGui::BeginChild(
		...
		case 1:
			ImGui::Checkbox("Thirdperson", &globals::thirdperson);
			if (ImGui::IsItemHovered())
				ImGui::SetTooltip("Just a cool feature");
		...
		case 2:
			...
			ImGui::Checkbox("FOV Changer", &globals::FOV);
			if (ImGui::IsItemHovered())
				ImGui::SetTooltip("Changes FOV");

			ImGui::Checkbox("Normal FOV", &globals::norFOV);
			if (ImGui::IsItemHovered())
